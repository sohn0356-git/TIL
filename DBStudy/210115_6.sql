...
ALTER TABLE IF EXISTS order_detail DROP CONSTRAINT item_fk_detail;
ALTER TABLE IF EXISTS order_detail DROP CONSTRAINT order_fk_detail;
ALTER TABLE IF EXISTS cart DROP CONSTRAINT user_fk_cart;
ALTER TABLE IF EXISTS cart DROP CONSTRAINT item_fk_cart;
ALTER TABLE IF EXISTS orders DROP CONSTRAINT user_fk_order;
