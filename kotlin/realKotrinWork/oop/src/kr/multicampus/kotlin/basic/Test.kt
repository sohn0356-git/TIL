fun main() {
    ...
    /*
        ...
        2. 변수선언
           ...
           3) val과 var의 차이점
              - val키워드로 선언된 변수는 초기에 셋팅한 값을 변경할 수 없다.
              - var키워드로 선언된 변수는 초기에 셋팅한 값을 변경할 수 있다.
           4) null처리를 정교하게
              - null값을 저장할 수 있는 변수와 저장할 수 없는 변수로 나누어서 관리
              -  var 변수명:타입 = null 의 형식로 선언하는 변수는 null값을 셋팅할 수 없다.
              -  var num6:Int ?=null의 형식으로 변수를 선언하면 null을 허용하는 변수가 된다.
              -  null을 허용하지 않는 변수에 null을 허용하는 변수의 값을 할당할 수 없다.
              -  null을 허용하지 않는 변수에 null을 허용하는 변수의 값을 할당하기 위해서 !!를 뒤에 추가하면된다.
                 var num6:Int ?=null
                 var num7:Int = num6!!
     */
    //null에 대한 처리
    ...
    //num5 = num6;
    //num6 = num5;//null을 허용하는 변수 = null을 허용하지 않는 변수  ----> O
    var num7:Int = num6!!;
